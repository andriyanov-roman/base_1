...
/*case "9":
    ...
    private static void maxSalary() {
        ArrayList<Company> companies = CompanyUtil
    ...
    private static void sortUsersId() {
        ...
        for (int i = 0; i < users.size(); i++) {
            System.out.println(users.get(i).getName() + users.get(i).getSecondName() + " - " + users.get(i).getId());
        }
    }
    ...
    private static void checkUsersLogin() {
        ...
        for (int i = 0; i < users.size(); i++) {
            if (users.get(i).getName().equals(users.get(i).getLogin())) {
                System.out.println(" Имя и Логин совпадают у юзера : " + users.get(i).getName() + " " + users.get(i).getSecondName() + ", логин: " + users.get(i).getLogin());
            } else {
                break;
            }
        }
