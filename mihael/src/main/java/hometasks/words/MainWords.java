        ...
        public static void startWords()throws IOException{
            ...
            while(cont){
                ...
                switch (input){
                    ...
                    case "SAVE":
                        saveWordsToFile("mihael/src/main/java/hometasks/words/words.txt", true, words);
                        break;
                    case "LOAD":
                        words = loadWordsFromFile("mihael/src/main/java/hometasks/words/words.txt");
