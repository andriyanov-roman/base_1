...
public class CompanyUtil { // Создаем класс штампующий Организации("печеньки") из определенного шаблона Org
                ...
                switch (Methods.scanner.next()) {
                    case "a":
                        ...
                        for (String company : companies) {
                            employees = EmployeeUtil.getEmployees(("artem/src/main/java/additionalFiles/companies/" + company), ":");
                    ...
                    case "b":
                        ...
                        for (int i = 0; i < companies.length; i++) {
                            employees = EmployeeUtil.getEmployees(("artem/src/main/java/additionalFiles/companies/" + companies[i]), ":");
    ...
    public static void addCompany (String companyName, ArrayList<Employee> employees) throws IOException{
        FileWriter writer = new FileWriter("artem/src/main/java/additionalFiles/companies/"+companyName, true);
