...
public class Methods {
    ...
    public static void welcome() {
        System.out.println("\n1.Получить информацию о всех пользователях" +
                "\n2.Проверка совпадения логина с именем или Фамилией нажмите" +
                "\n3.Проверка совпадения и имен и фамилий у нескольких пользователей" +
                "\n4.Сортировать пользователей по id в порядке возростания" +
                "\n5.Получить полную информацию о сотрудниках компаний" +
                "\n6.Найти сотрудника с самой большой ЗП в каждой компании" +
                "\n7.Сортировка сотрудников компании 'C#' по ЗП" +
                "\n8.Сортировка сотрудников компании 'C++' по возрасту" +
                "\n9.Сортировка сотрудников компании 'Java' по длинне фамилии" +
                "\n10.Сортировка сотруников каждой компании по ЗП в порядке возростания" +
                "\n11.Добавить сотрудника");
    }
