package apps.shapes.view;

import apps.shapes.entity.Circle;
import apps.shapes.entity.Foursquare;
import apps.shapes.entity.Triangle;
import apps.shapes.model.MethodsShapes;
import apps.shapes.writerReadingShapes.WriterReadingShapes;
